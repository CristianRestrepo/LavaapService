...
public class ApplicationConfig extends Application {
     ...
     */
     private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(co.com.lavapp.servicio.impl.AsociarPromocionSubProductoImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.BuscarSubProductosImpl.class);
        resources.add(co.com.lavapp.servicio.impl.BuscarSubServicioImpl.class);
        resources.add(co.com.lavapp.servicio.impl.BuscarZonasImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarAsesorZonaImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ConsultarCalificacionPorPedidoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarCalificacionesImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarCalificacionesSegunPlantaPedidosImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ConsultarColorImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarColoresImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarCostoImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ConsultarDescripcionPedidoImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ConsultarPromocionActivaImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarPromocionImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarPromocionSubProductoYaAsociadaImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarPromocionesImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarProveedorImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarProveedorSegunUsuarioImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ConsultarSubProductoConCostoImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ConsultarSubProductosMasCostoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarSubProductosSegunProductoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarSubProductosSegunPromocionImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ConsultarUsuariosPorRolImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarZonaImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarZonaYaAsociadaImpl.class);
        resources.add(co.com.lavapp.servicio.impl.ConsultarZonasAsesorImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.EditarContrasenaSesionImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EditarCorreoSesionImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EditarCostoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EditarDepartamentoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EditarDescripcionPedidoAsesorImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EditarDescripcionPedidoImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.EditarHorarioImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.EliminarAsociacionPromocionSubProductoImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.EliminarCostoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EliminarDepartamentoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EliminarDescripcionPedidoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EliminarDescripcionesSegunPedidoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EliminarEstratoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EliminarFacturaImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EliminarHistoricoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.EliminarHorarioImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.EliminarPromocionImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.ModificarPromocionImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.RegistrarDescripcionPedidoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.RegistrarEstratoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.RegistrarFacturaImpl.class);
        resources.add(co.com.lavapp.servicio.impl.RegistrarHistoricoImpl.class);
        resources.add(co.com.lavapp.servicio.impl.RegistrarHorarioImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.RegistrarPedidoCompletoImpl.class);
        ...
        resources.add(co.com.lavapp.servicio.impl.RegistrarPromocionImpl.class);
