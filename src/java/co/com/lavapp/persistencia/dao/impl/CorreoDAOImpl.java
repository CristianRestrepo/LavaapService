...
public class CorreoDAOImpl implements CorreoDAO {
    ...
    @Override
    public int enviarMensajeRecibidoAlCliente(String email, int idPedido, String rutaArchivo) {
        int valor = 0;
        init();
        try {
            MimeMessage message = new MimeMessage(session);
            ...
            BodyPart adjunto = new MimeBodyPart();
            adjunto.setDataHandler(new DataHandler(new FileDataSource(rutaArchivo)));
            adjunto.setFileName("Orden trabajo N°" + idPedido + ".pdf");
    ...
    @Override
    public int enviarOrdenServicioAPlanta(String email, int idPedido, String rutaArchivo) {
        int valor = 0;
        init();
        try {
            MimeMessage message = new MimeMessage(session);
            ...
            BodyPart adjunto = new MimeBodyPart();
            adjunto.setDataHandler(new DataHandler(new FileDataSource(rutaArchivo)));
            adjunto.setFileName("Orden trabajo planta N°" + idPedido + ".pdf");
